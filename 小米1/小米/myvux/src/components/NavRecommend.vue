...
//        <!--loading:function () {-->
//          <!--axios.post("/goods/list").then( (result)=>{-->
//              <!--console.log('1111111111111111')-->
//              <!--console.log(result);-->
//              <!--if( result.data.error == 0 ){-->
//                  <!--this.datas = result.data.data;-->
//                  <!--this.arr1 = this.datas.slice(0,1);-->
//                  <!--this.arr2 = this.datas.slice(1);-->
...
//        <!--},-->
        getall:function () {
          var that = this;
          axios.get("/goods/good").then(function(res){
              that.datas = res.data.data;
              console.log(that.datas);
              that.arr1 = that.datas.slice(0,2);
              that.arr2 = that.datas.slice(2);
          }).catch(function(err){
              console.log(err);
          })
          var num = 0;
          $(document).on('scroll',window,function () {
            ...
            if(scrollTop + screenHeight > height -10 ){
                num++;
                axios.get('/goods/good?page=' + num).then(function (res) {
